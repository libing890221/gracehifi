<template>
  ...
  <div id="category" class="case-category">
    ...
    <div :class="{'category-slide': categorySlide}" class="category-item-slide" @click="categorytoggle" >
      <span></span>
      <span></span>
    </div>
    ...
    export default {
      ...
      methods:{
        categorytoggle: function(){
          this.categorySlide = !this.categorySlide;
          $('.category-item').slideToggle(100);
        },
          ...
          linkRun: function (msg){
            this.categorySlide = !this.categorySlide;
            this.activeType = msg;
            this.$router.push({name:'caseList',params:{id: msg}});
